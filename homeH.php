...
<body>
    <div class="nav">
        <div class="logo">
        <p><a href="homeH.php"><img class="img" src="images/3.png" alt=""></a> </p>
        </div>
        ...
        <div class="right-links">
            ...
            <a href="php/logout.php"> <button class="btn">Déconnecter</button> </a>
    ...
    <div class="butons" >
    <a href="Déclarer Naissance.php">
         <button class="btn1" >Nouvelle naissance</button></a>
         <a href="Déclarer Décès.php">
        <button class="btn2" >Nouveau deces</button></a>
       </div>
</body>
</html>