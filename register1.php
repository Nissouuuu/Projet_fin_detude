...
<div class="form-container">
   ...
   <?php 
         ...
         if(mysqli_num_rows($verify_query) !=0 ){
            ...
            mysqli_query($con,"INSERT INTO users(Nom,Prenom,Username,Email,Password,Télephone) VALUES('$nom','$prenom','$username','$email','$password','$tel')") or die("Erroe Occured");

            echo "<div class='message'>
                      <p>inscription réussie!</p>
                  </div> <br>";
            echo "<a href='home1.php'><button class='btn'>Retour</button>";
